MACRO(CHECK_FOR_VA_COPY RESULT)
  MESSAGE(STATUS "Check for va_copy")
  TRY_COMPILE(${RESULT} ${CMAKE_BINARY_DIR}
    ${CMAKE_SOURCE_DIR}/cmake/CheckForVaCopy.c)
  IF(${RESULT})
    MESSAGE(STATUS "Check for va_copy - found")
  ELSE()
    MESSAGE(STATUS "Check for va_copy - not found")
  ENDIF()
